        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd changepirce="0"
                    ...
                    :key="saleAttrVal.id"
                    :class="{active: saleAttrVal.isChecked == 1}"
                    @click="attrValChange(saleAttrVal, saleAttr.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a style="cursor:pointer;" @click="addShoppingCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async addShoppingCart() {
      try {
        await this.$store.dispatch('addCartItem', {skuId: this.$route.params.skuId, skuNum: this.skuNum});
        // 将本次添加购物车的商品信息存入 sessionStorage
